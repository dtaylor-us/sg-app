...
}catch (e48375){if((e48375 instanceof Error)){
var e = e48375;
return null;
} else {
throw e48375;
...
var and__38224__auto__ = cljs.core.map_QMARK_.call(null,msg);
if(and__38224__auto__){
var and__38224__auto____$1 = new cljs.core.Keyword(null,"msg-name","msg-name",-353709863).cljs$core$IFn$_invoke$arity$1(msg);
if(cljs.core.truth_(and__38224__auto____$1)){
var and__38224__auto____$2 = cljs.core.not_EQ_.call(null,new cljs.core.Keyword(null,"msg-name","msg-name",-353709863).cljs$core$IFn$_invoke$arity$1(msg),new cljs.core.Keyword(null,"ping","ping",-1670114784));
...
figwheel.client.socket.open = (function figwheel$client$socket$open(p__48376){
var map__48379 = p__48376;
var map__48379__$1 = ((((!((map__48379 == null)))?((((map__48379.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__48379.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__48379):map__48379);
var opts = map__48379__$1;
var retry_count = cljs.core.get.call(null,map__48379__$1,new cljs.core.Keyword(null,"retry-count","retry-count",1936122875));
var retried_count = cljs.core.get.call(null,map__48379__$1,new cljs.core.Keyword(null,"retried-count","retried-count",-2127867357));
var websocket_url = cljs.core.get.call(null,map__48379__$1,new cljs.core.Keyword(null,"websocket-url","websocket-url",-490444938));
var build_id = cljs.core.get.call(null,map__48379__$1,new cljs.core.Keyword(null,"build-id","build-id",1642831089));
...
socket.onclose = ((function (url,socket,WebSocket,temp__4655__auto__,map__48379,map__48379__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (x){
var retried_count__$1 = (function (){var or__38236__auto__ = retried_count;
...
return setTimeout(((function (retried_count__$1,url,socket,WebSocket,temp__4655__auto__,map__48379,map__48379__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (){
...
});})(retried_count__$1,url,socket,WebSocket,temp__4655__auto__,map__48379,map__48379__$1,opts,retry_count,retried_count,websocket_url,build_id))
,(function (){var x__38574__auto__ = (10000);
var y__38575__auto__ = ((2000) + ((500) * retried_count__$1));
return ((x__38574__auto__ < y__38575__auto__) ? x__38574__auto__ : y__38575__auto__);
})());
} else {
return null;
}
...
socket.onerror = ((function (url,socket,WebSocket,temp__4655__auto__,map__48379,map__48379__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (x){
