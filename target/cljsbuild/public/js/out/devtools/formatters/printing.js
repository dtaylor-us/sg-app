...
var len__39344__auto___40226 = arguments.length;
var i__39345__auto___40227 = (0);
while(true){
if((i__39345__auto___40227 < len__39344__auto___40226)){
args__39351__auto__.push((arguments[i__39345__auto___40227]));

var G__40228 = (i__39345__auto___40227 + (1));
i__39345__auto___40227 = G__40228;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__39352__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq40223){
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__40224,G__40225,seq40223__$2);
});
...
if(cljs.core.truth_((function (){var or__38236__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__38842__auto__,writer__38843__auto__,opt__38844__auto__){
return cljs.core._write.call(null,writer__38843__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__38224__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__38224__auto__){
var or__38236__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__38236__auto__)){
return or__38236__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__40229_SHARP_){
return cljs.core.some_QMARK_.call(null,cljs.core.meta.call(null,p1__40229_SHARP_));
})))){
...
var markup_db = cljs.core.get.call(null,map__40238__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__38236__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e40242){var e__40004__auto__ = e40242;
return false;
}})();
if(cljs.core.truth_(or__38236__auto__)){
return or__38236__auto__;
...
}catch (e40244){var e__40004__auto__ = e40244;
return false;
}}
})())){
...
var _STAR_current_state_STAR_40249 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__40250 = opts;
var map__40250__$1 = ((((!((map__40250 == null)))?((((map__40250.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__40250.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__40250):map__40250);
var markup_db = cljs.core.get.call(null,map__40250__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_40249;
}});
...
;
var temp__4655__auto___40255 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___40255)){
var managed_print_level_40256 = temp__4655__auto___40255;
var _STAR_print_level_STAR_40254_40257 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_40256;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_40254_40257,managed_print_level_40256,temp__4655__auto___40255,writer,opts,job_fn){
return (function (p1__40252_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__40252_SHARP_,null);
});})(_STAR_print_level_STAR_40254_40257,managed_print_level_40256,temp__4655__auto___40255,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_40254_40257;
}} else {
job_fn.call(null);
}
