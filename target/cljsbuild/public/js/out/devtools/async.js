...
var o__40021__auto___52820 = (function (){var o__40021__auto__ = (function (){var o__40021__auto__ = Promise;
return goog.object.get(o__40021__auto__,"resolve").call(o__40021__auto__);
})();
return goog.object.get(o__40021__auto__,"then").call(o__40021__auto__,callback);
})();
goog.object.get(o__40021__auto___52820,"catch").call(o__40021__auto___52820,devtools.async.rethrow_outside_promise);
...
var G__52822_52823 = Error;
var target__40040__auto___52824 = G__52822_52823;
if(cljs.core.truth_(target__40040__auto___52824)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("unable to locate object path "),cljs.core.str(null),cljs.core.str(" in "),cljs.core.str(G__52822_52823)].join('')),cljs.core.str("\n"),cljs.core.str("target__40040__auto__")].join('')));
}

goog.object.set(target__40040__auto___52824,cljs.core.last.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["stackTraceLimit"], null)),Infinity);
