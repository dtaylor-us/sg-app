...
var args41137 = [];
var len__39344__auto___41143 = arguments.length;
var i__39345__auto___41144 = (0);
while(true){
if((i__39345__auto___41144 < len__39344__auto___41143)){
args41137.push((arguments[i__39345__auto___41144]));

var G__41145 = (i__39345__auto___41144 + (1));
i__39345__auto___41144 = G__41145;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args41137.length)].join('')));
...
if(typeof devtools.toolbox.t_devtools$toolbox41140 !== 'undefined'){
} else {
...
*/
devtools.toolbox.t_devtools$toolbox41140 = (function (obj,header,style,tag,meta41141){
this.obj = obj;
this.header = header;
this.style = style;
this.tag = tag;
this.meta41141 = meta41141;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
})
devtools.toolbox.t_devtools$toolbox41140.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_41142,meta41141__$1){
var self__ = this;
var _41142__$1 = this;
return (new devtools.toolbox.t_devtools$toolbox41140(self__.obj,self__.header,self__.style,self__.tag,meta41141__$1));
});

devtools.toolbox.t_devtools$toolbox41140.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_41142){
var self__ = this;
var _41142__$1 = this;
return self__.meta41141;
});

devtools.toolbox.t_devtools$toolbox41140.prototype.devtools$protocols$IFormat$ = cljs.core.PROTOCOL_SENTINEL;

devtools.toolbox.t_devtools$toolbox41140.prototype.devtools$protocols$IFormat$_header$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox41140.prototype.devtools$protocols$IFormat$_has_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return true;
});

devtools.toolbox.t_devtools$toolbox41140.prototype.devtools$protocols$IFormat$_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox41140.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"obj","obj",-1672671807,null),new cljs.core.Symbol(null,"header","header",1759972661,null),new cljs.core.Symbol(null,"style","style",1143888791,null),new cljs.core.Symbol(null,"tag","tag",350170304,null),new cljs.core.Symbol(null,"meta41141","meta41141",836100633,null)], null);
});

devtools.toolbox.t_devtools$toolbox41140.cljs$lang$type = true;

devtools.toolbox.t_devtools$toolbox41140.cljs$lang$ctorStr = "devtools.toolbox/t_devtools$toolbox41140";

devtools.toolbox.t_devtools$toolbox41140.cljs$lang$ctorPrWriter = (function (this__38842__auto__,writer__38843__auto__,opt__38844__auto__){
return cljs.core._write.call(null,writer__38843__auto__,"devtools.toolbox/t_devtools$toolbox41140");
});

devtools.toolbox.__GT_t_devtools$toolbox41140 = (function devtools$toolbox$__GT_t_devtools$toolbox41140(obj__$1,header__$1,style__$1,tag__$1,meta41141){
return (new devtools.toolbox.t_devtools$toolbox41140(obj__$1,header__$1,style__$1,tag__$1,meta41141));
});

}

return (new devtools.toolbox.t_devtools$toolbox41140(obj,header,style,tag,cljs.core.PersistentArrayMap.EMPTY));
});
