...
var len__39011__auto___44113 = arguments.length;
var i__39012__auto___44114 = (0);
while(true){
if((i__39012__auto___44114 < len__39011__auto___44113)){
args__39018__auto__.push((arguments[i__39012__auto___44114]));

var G__44115 = (i__39012__auto___44114 + (1));
i__39012__auto___44114 = G__44115;
continue;
} else {
}
break;
...
return markdown.common.freeze_string.cljs$core$IFn$_invoke$arity$variadic(argseq__39019__auto__);
});
...
markdown.common.freeze_string.cljs$lang$applyTo = (function (seq44112){
return markdown.common.freeze_string.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq44112));
});
...
var G__44118 = cljs.core.reduce.call(null,((function (text,state,matches,temp__4655__auto__){
return (function (s,r){
...
return cljs.core.get.call(null,new cljs.core.Keyword(null,"frozen-strings","frozen-strings",-1410661560).cljs$core$IFn$_invoke$arity$1(state),p1__44116_SHARP_,p1__44116_SHARP_);
});})(text,state,matches,temp__4655__auto__))
);
});})(text,state,matches,temp__4655__auto__))
,text,matches);
var G__44119 = cljs.core.update.call(null,state,new cljs.core.Keyword(null,"frozen-strings","frozen-strings",-1410661560),((function (text,state,matches,temp__4655__auto__){
return (function (p1__44117_SHARP_){
return cljs.core.apply.call(null,cljs.core.dissoc,p1__44117_SHARP_,matches);
});})(text,state,matches,temp__4655__auto__))
);
text = G__44118;
state = G__44119;
...
var args44120 = [];
var len__39011__auto___44129 = arguments.length;
var i__39012__auto___44130 = (0);
while(true){
if((i__39012__auto___44130 < len__39011__auto___44129)){
args44120.push((arguments[i__39012__auto___44130]));

var G__44131 = (i__39012__auto___44130 + (1));
i__39012__auto___44130 = G__44131;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args44120.length)].join('')));
...
var vec__44123 = (((transformer === cljs.core.identity))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [buf,cur_state], null):(function (){var vec__44126 = transformer.call(null,clojure.string.join.call(null,buf),cur_state);
var s = cljs.core.nth.call(null,vec__44126,(0),null);
var new_state = cljs.core.nth.call(null,vec__44126,(1),null);
...
var new_buf = cljs.core.nth.call(null,vec__44123,(0),null);
var new_state = cljs.core.nth.call(null,vec__44123,(1),null);
var G__44133 = cljs.core.vec.call(null,cljs.core.concat.call(null,out,cljs.core.seq.call(null,open),new_buf,cljs.core.seq.call(null,close)));
var G__44134 = cljs.core.PersistentVector.EMPTY;
var G__44135 = cljs.core.rest.call(null,tokens);
var G__44136 = cljs.core.assoc.call(null,new_state,new cljs.core.Keyword(null,"found-token","found-token",113525576),false);
out = G__44133;
buf = G__44134;
tokens = G__44135;
cur_state = G__44136;
...
var G__44137 = out;
var G__44138 = cljs.core.into.call(null,buf,cljs.core.first.call(null,tokens));
var G__44139 = cljs.core.rest.call(null,tokens);
var G__44140 = cur_state;
out = G__44137;
buf = G__44138;
tokens = G__44139;
cur_state = G__44140;
...
var G__44141 = out;
var G__44142 = buf;
var G__44143 = cljs.core.rest.call(null,tokens);
var G__44144 = cljs.core.assoc.call(null,cur_state,new cljs.core.Keyword(null,"found-token","found-token",113525576),true);
out = G__44141;
buf = G__44142;
tokens = G__44143;
cur_state = G__44144;
...
var G__44145 = cljs.core.into.call(null,out,cljs.core.first.call(null,tokens));
var G__44146 = buf;
var G__44147 = cljs.core.rest.call(null,tokens);
var G__44148 = cur_state;
out = G__44145;
buf = G__44146;
tokens = G__44147;
cur_state = G__44148;
...
var num_hashes = cljs.core.count.call(null,cljs.core.filter.call(null,(function (p1__44149_SHARP_){
return cljs.core.not_EQ_.call(null," ",p1__44149_SHARP_);
}),cljs.core.take_while.call(null,(function (p1__44150_SHARP_){
return (cljs.core._EQ_.call(null,"#",p1__44150_SHARP_)) || (cljs.core._EQ_.call(null," ",p1__44150_SHARP_));
