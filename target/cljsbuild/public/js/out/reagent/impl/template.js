...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__38842__auto__,writer__38843__auto__,opt__38844__auto__){
return cljs.core._write.call(null,writer__38843__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__41467 = o;
(G__41467[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__41469__i < G__41469__a.length) {G__41469__a[G__41469__i] = arguments[G__41469__i + 0]; ++G__41469__i;}
  args = new cljs.core.IndexedSeq(G__41469__a,0);
} 
...
if(cljs.core.truth_((function (){var and__38224__auto__ = cljs.core.some_QMARK_.call(null,jsprops);
if(and__38224__auto__){
var and__38224__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__41476 = jsprops;
(G__41476["defaultValue"] = value);

(G__41476["onChange"] = ((function (G__41476,v,value,on_change){
return (function (p1__41473_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__41473_SHARP_);
});})(G__41476,v,value,on_change))
);

(G__41476["ref"] = ((function (G__41476,v,value,on_change){
return (function (p1__41474_SHARP_){
return (this$["cljsInputElement"] = p1__41474_SHARP_);
});})(G__41476,v,value,on_change))
);
...
var vec__41483 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__41483,(0),null);
var id = cljs.core.nth.call(null,vec__41483,(1),null);
var class$ = cljs.core.nth.call(null,vec__41483,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___41488 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___41488 == null)){
} else {
var key_41489 = temp__4661__auto___41488;
(jsprops["key"] = key_41489);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__41491 = (new reagent.impl.template.NativeWrapper());
(G__41491["name"] = c);
...
var len__39344__auto___41497 = arguments.length;
var i__39345__auto___41498 = (0);
while(true){
if((i__39345__auto___41498 < len__39344__auto___41497)){
args__39351__auto__.push((arguments[i__39345__auto___41498]));

var G__41499 = (i__39345__auto___41498 + (1));
i__39345__auto___41498 = G__41499;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__39352__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq41495){
var G__41496 = cljs.core.first.call(null,seq41495);
var seq41495__$1 = cljs.core.next.call(null,seq41495);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__41496,seq41495__$1);
});
...
break;
default:
var G__41503 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__41503;
continue;
...
var n__39154__auto___41506 = a.length;
var i_41507 = (0);
while(true){
if((i_41507 < n__39154__auto___41506)){
(a[i_41507] = reagent.impl.template.as_element.call(null,(a[i_41507])));

var G__41508 = (i_41507 + (1));
i_41507 = G__41508;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__39154__auto___41509 = a.length;
var i_41510 = (0);
while(true){
if((i_41510 < n__39154__auto___41509)){
var val_41511 = (a[i_41510]);
if((cljs.core.vector_QMARK_.call(null,val_41511)) && ((reagent.impl.template.key_from_vec.call(null,val_41511) == null))){
(o["no-key"] = true);
} else {
}

(a[i_41510] = reagent.impl.template.as_element.call(null,val_41511));

var G__41512 = (i_41510 + (1));
i_41510 = G__41512;
continue;
} else {
}
...
var ctx = ({});
var vec__41516 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__41516,(0),null);
var derefed = cljs.core.nth.call(null,vec__41516,(1),null);
...
var G__41520 = (cljs.core.count.call(null,argv) - first_child);
switch (G__41520) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__41520){
