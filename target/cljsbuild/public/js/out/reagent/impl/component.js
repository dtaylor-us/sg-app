...
if((i < len)){
var k = (ks[i]);
var G__41418 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),(o[k]));
var G__41419 = (i + (1));
m = G__41418;
i = G__41419;
continue;
...
return (cljs.core.fn_QMARK_.call(null,c)) && (cljs.core.some_QMARK_.call(null,(function (){var G__41423 = c;
var G__41423__$1 = (((G__41423 == null))?null:G__41423.prototype);
if((G__41423__$1 == null)){
return null;
} else {
return (G__41423__$1["reagentRender"]);
}
})()));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return (cljs.core.fn_QMARK_.call(null,c)) && (cljs.core.some_QMARK_.call(null,(function (){var G__41427 = c;
var G__41427__$1 = (((G__41427 == null))?null:G__41427.prototype);
if((G__41427__$1 == null)){
return null;
} else {
return (G__41427__$1["render"]);
}
})()));
});
...
return (function() { 
var G__41431__delegate = function (args){
...
while (G__41432__i < G__41432__a.length) {G__41432__a[G__41432__i] = arguments[G__41432__i + 0]; ++G__41432__i;}
  args = new cljs.core.IndexedSeq(G__41432__a,0);
} 
return G__41431__delegate.call(this,args);};
G__41431.cljs$lang$maxFixedArity = 0;
G__41431.cljs$lang$applyTo = (function (arglist__41433){
var args = cljs.core.seq(arglist__41433);
return G__41431__delegate(args);
});
...
var _STAR_current_component_STAR_41436 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_41436;
}});
...
var G__41440 = (((key instanceof cljs.core.Keyword))?key.fqn:null);
switch (G__41440) {
...
var or__38236__auto__ = reagent.impl.util._STAR_always_update_STAR_;
...
var c = this;
var G__41442_41444 = (c["cljsRatom"]);
if((G__41442_41444 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__41442_41444);
}
...
if(cljs.core.truth_((function (){var and__38224__auto__ = wrap;
...
if(((1) === cljs.core.count.call(null,renders_41447))){
} else {
...
if(cljs.core.ifn_QMARK_.call(null,render_fun_41448)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("Render must be a function, not "),cljs.core.str(cljs.core.pr_str.call(null,render_fun_41448))].join('')),cljs.core.str("\n"),cljs.core.str("(ifn? render-fun)")].join('')));
}


var render_fun = (function (){var or__38236__auto__ = new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383).cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__38236__auto__)){
return or__38236__auto__;
} else {
...
var render_fun__$1 = (function (){var or__38236__auto__ = render_fun;
if(cljs.core.truth_(or__38236__auto__)){
return or__38236__auto__;
} else {
...
var name = [cljs.core.str((function (){var or__38236__auto__ = new cljs.core.Keyword(null,"displayName","displayName",-809144601).cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__38236__auto__)){
return or__38236__auto__;
} else {
...
var name__$1 = (function (){var G__41446 = name;
switch (G__41446) {
case "":
...
var G__41451 = o;
(G__41451[cljs.core.name.call(null,k)] = v);
...
var elem = (function (){var G__41457 = (function (){var or__38236__auto__ = (function (){var G__41459 = c;
if((G__41459 == null)){
return null;
} else {
return (G__41459["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__38236__auto__)){
return or__38236__auto__;
...
return (G__41457["_currentElement"]);
}
})();
var name = (function (){var G__41460 = elem;
var G__41460__$1 = (((G__41460 == null))?null:(G__41460["type"]));
if((G__41460__$1 == null)){
return null;
} else {
return (G__41460__$1["displayName"]);
}
})();
var path = (function (){var G__41461 = elem;
var G__41461__$1 = (((G__41461 == null))?null:(G__41461["_owner"]));
var G__41461__$2 = (((G__41461__$1 == null))?null:reagent.impl.component.component_path.call(null,G__41461__$1));
if((G__41461__$2 == null)){
return null;
} else {
return [cljs.core.str(G__41461__$2),cljs.core.str(" > ")].join('');
}
})();
...
var n = (function (){var or__38236__auto__ = reagent.impl.component.component_path.call(null,c);
if(cljs.core.truth_(or__38236__auto__)){
return or__38236__auto__;
} else {
var G__41463 = c;
var G__41463__$1 = (((G__41463 == null))?null:G__41463.constructor);
if((G__41463__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name.call(null,G__41463__$1);
}
}
})();
